...
<body>
  ...
  <div class="box">
    ...
    <div id="upgrade3" class="upgradeBox">
      ...
      <p>Kitten Checkpoint will respawn 2 kitten every second</p>
      <p>Cost: <span class="cost">500</span></p>
      <p>Amount: <span class="amount">0</span></p>
    </div>
    <div id="upgrade4" class="upgradeBox">
      <img class="upgradeImage" src="kitten-portal.gif">
      <p>Kitten Portal will pull an interdimensional 8 kittens every second</p>
    ...
    <div id="upgrade6" class="upgradeBox">
      ...
      <p>Kitten Satan resurrects fallen kittens from the pits of hell. 200 kittens every second</p>
  ...
  var upgrade2_payout = 0.33;

  var upgrade3_amount = 0;
  var upgrade3_cost = 500;
  var upgrade3_payout = 2;

  var upgrade4_amount = 0;
  var upgrade4_cost = 2000;
  var upgrade4_payout = 8;
  ...
  $("#upgrade6").click(function(){
    if(score >= upgrade6_cost){
      ...
      upgrade6_cost = Math.floor(1.2 * upgrade6_cost);
